...
#creates a flask group
cli = FlaskGroup(create_app=create_app)

#creates a list which stores all the user data
user_json = [
	{
		"name": "John Doe",
...
# creates a list which stores info of all the product
product_json = [
	{
...
# it is used to delete or modify database tables
def recreate_db():
	db.drop_all()
	db.create_all()
	db.session.commit()

# adds all the new users and objects info from the database
def seeder():
